;TESTS :
(LISP2LI '(defun test_set (x) (setf x 1)) ())
=>(:SET-VAR (:VAR 0) (:CONST 1))

(LISP2LI '(if (< x 0) 1 0) '(x))
=> (:IF (:CALL < ((:VAR 0) (:CONST 0))) (:CONST 1) (:CONST 0))

(LISP2LI '(defun factorielle (n) (if (<= n 0) 1 (* n (factorielle (- n 1))))) ())
=> (:IF (:CALL <= ((:VAR 0) (:CONST 0))) (:CONST 1) (:CALL * ((:VAR 0) (:MCALL FACTORIELLE ((:CALL - ((:VAR 0) (:CONST 1))))))))

(LISP2LI '(defun fibonacci (n) (if (<= n 2) 1 (+ (fibonacci (- n 1)) (fibonacci (- n 2))))) ())
=> (:IF (:CALL <= ((:VAR 0) (:CONST 2))) (:CONST 1) (:CALL + ((:MCALL FIBONACCI ((:CALL - ((:VAR 0) (:CONST 1))))) (:MCALL FIBONACCI ((:CALL - ((:VAR 0) (:CONST 2))))))))

(LISP2LI '(defun test_quote (x) '(setf x 1)) ())
=> (:CONST (SETF X 1))

(LISP2LI '(defun test_progn_sur_factorielle (x) (progn (defun factorielle (n) (if (<= n 0) 1 (* n (factorielle (- n 1)))))) ()) ())
=> (:PROGN ((:IF (:CALL <= ((:VAR 0) (:CONST 0))) (:CONST 1) (:CALL * ((:VAR 0) (:UNKNOWN (FACTORIELLE (- N 1)) (N)))))))

(LISP2LI '(defun test_loop () (loop for i from 1 to 10 do (print i))) ())
...
(defun LISP2LI (expr env) (if (atom expr) (if (constantp expr) (list :const expr) (let ((pos (position expr env))) (if pos (list :var pos) (list :unknown expr)))) (let ((fun (car expr)) (args (cdr expr))) (cond ((eq 'defun fun) (setf (get (first args) :defun) (LISP2LI (third args) (second args)))) ((eq 'setf fun) (if (symbolp (second expr)) (list :set-var (LISP2LI (second expr) env) (LISP2LI (third expr) env)) (list :setf (LISP2LI (second expr) env)))) ((eq 'quote fun) (list :const (first args))) ((eq 'if fun) (cons :if (MAPLISP2LI args env))) ((eq 'progn fun) (list :progn (MAPLISP2LI args env))) ((not (null (get fun :defun))) (list :mcall fun (MAPLISP2LI args env))) ((not (fboundp fun)) (list :unknown (cons fun args) env)) ((fboundp fun) (list :call fun(MAPLISP2LI args env)))))))
(defun MAPLISP2LI (lexpr env) (if (atom lexpr) NIL (cons (LISP2LI (first lexpr) env) (MAPLISP2LI (rest lexpr) env))))
